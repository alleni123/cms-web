				...
				.uploadify(
						{
							...
							fileObjName : "pic", //服务器端用来获取对象的名称。 比如这里使用springmvc， 那就要在参数中用MultipartFile pic来获取这里的上传文件
							buttonText:"上传文件",
							height : 30,
							width : 120,
		...
		<div id="contents">
			...
			<sf:form method="post" modelAttribute="indexPic" id="addForm">
				<table width="980" cellspacing="0" cellpadding="0" id="addTable">
					...
					<!-- 上传图片 -->
					<tr>
						<td colspan="2" class="centerTd"><input type="file" id="indexPic" name="indexPic" /> 
					...
					<tr>
						...
						<td class="leftTd"><sf:input path="linkUrl" /> <sf:errors cssClass="errorContainer"
								path="linkUrl" />
						</td>
					</tr>
					...
					<tr>
						<td colspan="2" class="centerTd"><input type="submit" id="addBtn" value="添加首页图片" /> <input
							type="reset" value="重置" />
						</td>
					</tr>
